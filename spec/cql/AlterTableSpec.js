...
describe('alter table', function () {
    it('sets column type with strings', function () {
        expect(new AlterTable()
            ...
            .type('col', 'text')
            .parameterize()
        ).toEqual([[], 'ALTER TABLE tbl ALTER col TYPE text;']);
    });
    ...
    it('adds columns with strings', function () {
        expect(new AlterTable()
            ...
            .add('col', 'text')
            .parameterize()
        ).toEqual([[], 'ALTER TABLE tbl ADD col text;']);
    });
    ...
    it('drops columns', function () {
        expect(new AlterTable()
            ...
            .drop(t.Text('col'))
            .parameterize()
        ).toEqual([[], 'ALTER TABLE tbl DROP col;']);
    });
    it('renames columns', function () {
        expect(new AlterTable()
            ...
            .rename('col1', 'col2')
            .parameterize()
        ).toEqual([[], 'ALTER TABLE tbl RENAME col1 TO col2;']);
    });
    it('updates column properties single', function () {
        expect(new AlterTable()
            ...
            .parameterize()
        ).toEqual([[], 'ALTER TABLE tbl WITH comment = \'Hello World\';']);
    });
    it('updates column properties multiple', function () {
        expect(new AlterTable()
            ...
            .parameterize()
        ).toEqual([[], 'ALTER TABLE tbl WITH comment = \'Hello World\' AND read_repair_chance = 0.2;']);
    });
});
