...
Model.prototype.bindAccessors = function () {
    ...
    this.def('accessored', _.union(_.keys(this.getters), _.keys(this.setters)));

    _.forEach(this.accessored, function (key) {
        ...
        properties[key] = {
            ...
            get: function () {
                if (typeof getter === 'undefined') {
                    ...
                    return getter.call(this, this.attributes[key]);
                }
            },
            set: function (value) {
                if (typeof setter === 'undefined') {
                    ...
                    this.attributes[key] = setter.call(this, value);
                }
            }
        };
    }, this);

    if (this.accessored.length > 0) {
...
Model.prototype.sync = function (attributes) {
    ...
    Object.keys(attributes).forEach(function (key) {
        ...
        if (self.accessored.indexOf(name) === -1) {
 ...
 */
Model.prototype.fixAttributes = function () {
    for (var i = 0, l = this.columns.length; i < l; i++) {
        var column = this.columns[i];
        var name = column.getName();
        var value;

        if (this.accessored.indexOf(name) !== -1) {
            value = this.attributes[name];
            this.attributes[name] = this.collection.typecast(column, value);
        } else {
            value = this.collection.typecast(column, this[name]);
