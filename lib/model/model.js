...
function Model (collection, attributes) {
    ...
    this.def('createNew',
        this.wrapAround('beforeCreate', this.createNew, 'afterCreate'));
    this.def('updateExisting',
        this.wrapAround('beforeUpdate', this.updateExisting, 'afterUpdate'));
    this.def('delete',
        this.wrapAround('beforeDelete', this.delete, 'afterDelete'));
 ...
 * @return {Promise}
 */
Model.prototype.wrapAround = function (before, fn, after) {
    var self = this;
 ...
 * @return {Promise}
 */
Model.prototype.delete = function (force) {
