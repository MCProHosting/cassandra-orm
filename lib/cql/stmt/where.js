...
Where.prototype.resolveColumn = function (column) {
    ...
    if (_.isArray(column)) {
        return '(' + column.map(this.resolveColumn.bind(this)).join(', ') + ')';
    } else {
        return util.resolveName(column);
    }
};
...
Where.prototype.baseWhere = function (column, operation, term) {
    if (typeof operation === 'undefined') {
        ...
        if (typeof column === 'function') {
            ...
            return;
        } else if (util.isRaw(column)) {
            this.statements.push(column.text);
            return;
        }
    }
...
Where.prototype.parameterize = function () {
    return [this.parameters, this.statements.map(function (statement) {
