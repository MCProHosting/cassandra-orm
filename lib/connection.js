...
require('util').inherits(Connection, events.EventEmitter);
...
Connection.prototype.execute = function (stmt, params, options) {
    ...
    this.emit('query', stmt, params, options);
...
Connection.errors =
Connection.prototype.errors = require('./errors');

Connection.policies =
Connection.prototype.policies = cassandra.policies;

Connection.auth =
Connection.prototype.auth = cassandra.auth;
